{* @file /templates/frontend/components/ui/material_icon_orcid.tpl
 *
 * Copyright (c) 2025 Madi N.
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @brief Svg orcid icon
 *}

<svg class="w-4 h-4 shrink-0" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
